...
public class AnouncementJPanel extends javax.swing.JPanel {
    ...
    public AnouncementJPanel(JPanel userProcessContainer, UserAccount userAccount, CollegeOrganization organization) {
        ...
        if (txtAn.getText().trim().isEmpty()) {
            ...
            for (UserAccount ua : organization.getUserAccountDirectory().getUserAccountList()) {
               if(ua.getRole() instanceof ProfessorRole){
                   ...
                   for(UserAccount u : role.getResearchAssistants()){
                       if(u.getId() == userAccount.getId())
                           ua.createFeeds("Work Report by " + userAccount.getEmployee().getName() + " : " + txtAn.getText());
                   }
    ...
    private void backbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backbtnActionPerformed
        ...
        RAWorkAreaJPanel panel = (RAWorkAreaJPanel) component;
        panel.populateTable();
