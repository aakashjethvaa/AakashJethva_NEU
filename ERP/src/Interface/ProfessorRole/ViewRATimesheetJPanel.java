 ...
 * @author karan
 */
public class ViewRATimesheetJPanel extends javax.swing.JPanel {
    ...
    public ViewRATimesheetJPanel(JPanel userProcessContainer, Program program, UserAccount userAccount, CollegeOrganization organization) {
        initComponents();
    ...
    private void btnApproveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApproveActionPerformed
        ...
        if (selected >= 0) {
            RAHours hrs = (RAHours) tblTimesheetDetails.getValueAt(selected, 5);
            if (hrs.getStatus().equals("Submitted")) {
                hrs.setStatus("Approved");

                UserAccount u = (UserAccount) cmbTANames.getSelectedItem();
                u.createFeeds("RA hours for " + tblTimesheetDetails.getValueAt(selected, 1) + " has been approved.");
